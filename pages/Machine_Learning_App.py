...
def read_file(uploaded_file):
    try:
        ...
        data2=pd.read_excel(uploaded_file,header=True,nrows=10000)
    
    for col in data2.columns:
        if data2.dtypes[col]=='object':
            data2.astype({col: 'str'})
...
try:
    ...
    if reg_cla=='Dimensionality Reduction':
        ...
        #date_col=[col for col in data2.columns if data2.dtypes[col]=='datetime64' or 'timedelta[ns]']
    ...
    if regtype=='Decision Tree':
            ...
            if rmp1=='y':
                tuned_dt_model1,tr_r2,te_r2,best_params=decision_tree(X_train,X_test,y_train,y_test,n_splits,grid_search_dt)
